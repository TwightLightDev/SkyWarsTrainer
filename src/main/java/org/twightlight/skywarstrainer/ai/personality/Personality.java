...
public enum Personality {
    ...
    /**
     * Wants blood. Prioritizes engaging enemies over everything else. Rushes mid early,
     * picks fights even when under-geared, chases low-HP enemies relentlessly.
     */
    ...
    /**
     * Avoids fights unless cornered or has overwhelming advantage. Prefers to loot fully,
     * enchant, and only fight in endgame.
     */
    PASSIVE("Passive",
    ...
    /**
     * Pure speed. Rushes to mid island immediately for the best loot, ignoring own island chests.
     */
    RUSHER("Rusher",
    ...
    /**
     * Finds a defensible position and fortifies. Watches bridges, waits for enemies to come.
     */
    CAMPER("Camper",
    ...
    /**
     * Makes optimal decisions based on situation. Reads enemy gear, tracks player count,
     * uses the environment (void, lava, KB edges).
     */
    STRATEGIC("Strategic",
    ...
    /**
     * Loot goblin. Wants every item on the map. Systematic chest pathing. Fights only
     * when fully stacked.
     */
    COLLECTOR("Collector",
    ...
    /**
     * All-in fighter. No retreating, no careful play. Burns golden apples, spam-clicks,
     * charges head-first.
     */
    BERSERKER("Berserker",
    ...
    /**
     * Prefers ranged combat. Prioritizes bow, fishing rod, snowballs, eggs. Keeps distance.
     */
    SNIPER("Sniper",
    ...
    /**
     * Uses dirty tricks and creative plays. Pearl plays, block traps, bridge breaking,
     * KB fishing rod near void, fake-retreat baits.
     */
    TRICKSTER("Trickster",
    ...
    /**
     * Very careful and calculated. Always checks surroundings. Crouches near edges,
     * builds side-rails, checks behind frequently.
     */
    CAUTIOUS("Cautious",
    ...
    /**
     * Excels at high-pressure situations. Water bucket MLG, block clutching, ender pearl saves.
     */
